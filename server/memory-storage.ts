...
export class MemoryStorage implements IStorage {
  ...
  private initializeDefaultData() {
    ...
    // Create demo faculty account - 이영학 교수
    ...
    const sampleAgents: any[] = [
      ...
      },
      {
        id: 2,
        name: "이영학 에이전트",
        description: "컴퓨터공학과 이영학 교수의 전문 상담 에이전트입니다",
        category: "교수",
        icon: "User",
        backgroundColor: "purple",
        isActive: true,
        isCustomIcon: false,
        speakingStyle: "전문적이고 학술적인 말투",
        personalityTraits: "컴퓨터공학 전문가로서 학생들에게 체계적이고 깊이 있는 지식을 전달하는 성격",
        prohibitedWordResponse: "죄송합니다. 해당 내용에 대해서는 답변드릴 수 없습니다.",
        llmModel: "gpt-4o",
